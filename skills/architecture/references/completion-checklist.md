...
- [ ] `form!` is used for a distinct static UI schema; **(0.4.0)** a `ClientForm` companion is used only when a non-generic named request DTO is the canonical supported form contract
