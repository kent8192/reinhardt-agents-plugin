...
All notable changes to the **reinhardt-cc** Claude Code plugin are documented in this file.
...
(2026-04-29 → 2026-05-13, 153 PRs upstream). Tracking issue: [#9](https://github.com/kent8192/reinhardt-cc/issues/9).
...
- Initial public release of the reinhardt-cc plugin (skills for scaffolding, modeling,
