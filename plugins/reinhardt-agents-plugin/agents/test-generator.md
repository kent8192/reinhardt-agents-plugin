...
8. **Typed events**: Use exact intrinsic payloads, `EventFixture`, and `Screen::settle()` after async or reactive writes; keep raw events in explicit escape-hatch tests.
