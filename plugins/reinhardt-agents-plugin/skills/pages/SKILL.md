...
- User builds nested layout routes with `#[layout]`, `Outlet`, or async SSR/resource hydration
- User mentions: "page", "head", "form", "server_fn", "Signal", "useState", "useEffect", "watch", "i18n", "translation", "locale", "t!", "SSR", "hydration", "WASM", "frontend", "router", "ClientRouter", "Outlet", "SsrStream", "ApiQuerySet", "Table", "prelude", "component", "layout"
