...
- `#[server_fn]` functions should inject keyed services for application business logic (`Depends<K, Service>`) instead of constructing settings directly and calling free functions
