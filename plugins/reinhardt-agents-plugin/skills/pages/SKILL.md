...
- Use `use_retained_effect` / `use_retained_layout_effect` when registration-style code intentionally does not own the returned effect guard; use ordinary effects when RAII ownership and early disposal are desired.
